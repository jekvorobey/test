    ...
    <section class="section seo-view">
        ...
        <info-panel class="seo-view__panel" header="Лаки для ногтей Mood">
            ...
            <v-html
                ...
                v-html="
                    `<p>Гибридные и такие эмоциональные лаки MOOD!</p>
        ...
        <info-panel class="seo-view__panel" header="Сухой шампунь R+CO">
            ...
            <v-html
                ...
                v-html="
                    `<p>
                        Новинка R+Co разрушает привычные представления о том, что такое классический сухой шампунь. 
                    ...
                    <p>
                    Жидкий сухой шампунь Spiritualized Dry Shampoo Mist разработан для применения между основным мытьем головы, справляется с накопившимися укладочными средствами на поверхности волос. 
