                ...
                >
                    ...
                    <div class="container container--tablet partners-view__top-content">
                        ...
                        <p class="partners-view__top-content-text">
                            Первый в России маркетплейс для мастеров формирует&nbsp;на&nbsp;своей платформе
            ...
            <div class="container partners-view__cooperation">
                <div class="partners-view__cooperation-content">
                    ...
                    <ul class="partners-view__cooperation-content--list">
                        ...
                        <li>Партнерство с первым в России маркетплейсом для&nbsp;профессионалов индустрии красоты</li>
                    </ul>
                </div>
        ...
        sales: [
            {
                ...
                subTitle: 'Возможность поштучной отгрузки товаров со склада в радиусе до 50 км от Москвы',
            },
            {
                img: ParthnerSales2,
