<template>
    <section class="section ui-kit-section">
        ...
        <form>
            ...
            <v-check id="checkbox-7" v-model="checkboxes_checked" name="checkboxes" :value="values.second">{{
                values.second
            }}</v-check>
            <v-check id="checkbox-8" v-model="checkboxes_checked" name="checkboxes" :value="values.third">{{
                values.third
            }}</v-check>
...
export default {
    ...
    computed: {
        indeterminate() {
            return (
                this.checkboxes_checked.length > 0 && this.checkboxes_checked.length !== Object.keys(this.values).length
            );
        },
        allChecked() {
