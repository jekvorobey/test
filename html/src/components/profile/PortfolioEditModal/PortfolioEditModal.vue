        ...
        async onSubmit() {
            ...
            this[CHANGE_MODAL_STATE]({
                ...
                state: {
                    title: 'Уведомление',
                    message:
                        'Спасибо! Данные на подтверждение профессионального статуса отправлены на модерацию. Платформа работает в тестовом режиме. Мы проверим заявку после 10 мая и пришлем смс, когда закончим.',
                },
            });
        },
