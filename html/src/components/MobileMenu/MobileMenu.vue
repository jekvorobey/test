<template>
    <v-modal class="mobile-menu" :show-close-btn="false" type="fullscreen">
        <template v-slot:body>
            <v-sticky class="mobile-menu__sticky">
                <template v-slot:sticky>
                    <div v-if="!showCategories" class="container mobile-menu__header">
                        <button
                    ...
                    <div v-else class="container mobile-menu__header">
                        <button
                            class="mobile-menu__header-btn mobile-menu__header-btn--arrow"
