...
function render(req, res) {
    ...
    if (isProd) {
        /** Прелоадим фонты */
        const fonts = (clientManifest.all || []).filter(file => isWoff2(file));

        // eslint-disable-next-line
        for (const file of fonts)
            preloadedFonts += `<link rel="preload" as="font" href="/assets/${file}" type="font/woff2" crossorigin>`;
    }
